...
<div class="dashboard">
    ...
    <div class="dashboard-card">
        <div class="dashboard-card-header"><div><div class="dashboard-card-title">Saldo Rekening Bank</div><div class="dashboard-card-subtitle">Saldo akhir dan mutasi setiap rekening aktif</div></div></div>
