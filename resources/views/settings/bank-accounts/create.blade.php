...
<style>
    /* =========================================================
       ALMARA - BANK ACCOUNT CREATE
       Scoped khusus halaman Tambah Rekening Bank
       ========================================================= */
    ...
    .almara-bank-card {
        ...
        border-radius: 16px;
        box-shadow: 0 8px 28px rgba(24, 55, 73, 0.07);
        overflow: hidden;
    }
    ...
    .almara-bank-textarea-wrap:focus-within {
        border-color: #168b7c;
        box-shadow: 0 0 0 3px rgba(22, 139, 124, .11);
    }
    ...
    .almara-bank-btn-save:hover {
        ...
        box-shadow: 0 6px 14px rgba(8, 127, 112, .22);
    }

    .almara-bank-btn-icon {
        font-size: 17px;
        line-height: 1;
    }
...
<div class="almara-bank-page">
    ...
    <div class="almara-bank-header">
        <div>
            <h1 class="almara-bank-title">Tambah Rekening Bank</h1>
            <p class="almara-bank-subtitle">
                Daftarkan rekening bank untuk cabang aktif.
            </p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('settings.bank-accounts.store') }}">
        @csrf
        ...
        <div class="almara-bank-card">
            ...
            <div class="almara-bank-card-header">
                <div class="almara-bank-card-icon">
                    🏦
                </div>
                ...
                <div>
                    ...
                    <p class="almara-bank-card-description">
                        Lengkapi informasi rekening bank dengan benar.
                    </p>
                </div>
            </div>
            ...
            <div class="almara-bank-form">
                ...
                <div class="almara-bank-grid">
                    ...
                    <div class="almara-bank-field">
                        ...
                        <div class="almara-bank-help">
                            Saldo awal rekening sebelum mutasi dicatat.
                        </div>
                    </div>
                ...
                {{-- Information --}}
                <div class="almara-bank-notice">
                    <div class="almara-bank-notice-icon">i</div>

                    <div>
                        Rekening yang aktif dapat digunakan untuk transaksi
                        dan pencatatan mutasi bank.
                    </div>
                </div>
                ...
                <div class="almara-bank-active">
                    ...
                    >
                        ...
                        <span class="almara-bank-active-help">
                            Centang jika rekening ini aktif digunakan.
                        </span>
                    </label>
                </div>
            ...
            <div class="almara-bank-footer">
                ...
                >
                    <span class="almara-bank-btn-icon">←</span>
                    Batal
                </a>
