...
<div class="container-fluid py-4">
    <style>
        ...
        .mutation-filter{background:#f8fafc;border:1px solid #e5e7eb;border-radius:10px;padding:14px;margin-top:14px}
                ...
                <form method="GET" action="{{ route('settings.bank-accounts.index') }}" class="mutation-filter">
                    <div class="row g-2 align-items-end">
                        <div class="col-lg-5 col-md-6">
                            <label for="bank_account_id" class="form-label mb-1">Akun Bank</label>
